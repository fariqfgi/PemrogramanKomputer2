...
public class FontSetting {
    ...
    /**
     * * * @param fontName Nama Font * @param fontStyle Gaya Font, Bold=1,
     * Regular=0 * @param fontSize Ukuran Font
     */
    ...
    private boolean isContainer(Component comp) {
        return comp instanceof JPanel || comp instanceof JTabbedPane || comp instanceof JSplitPane || comp instanceof JScrollPane || comp instanceof JToolBar || comp instanceof JDesktopPane || comp instanceof JInternalFrame || comp instanceof JLayeredPane;
    }
